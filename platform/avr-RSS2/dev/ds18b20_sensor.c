...
*/
#include "contiki.h"
#include "dev/ds18b20_sensor.h"
#include <avr/io.h>
#include <util/delay.h>

const struct sensors_sensor ds18b20_temp_sensors;//temp_mcu_sensor
/*
 * ds18b20 init
 */
...
static int value(int type)//value(int type)
{  
  double ret;
  ret = ds18b20_gettemp();//ds18b20_gettemp
...
SENSORS_SENSOR(ds18b20_temp_sensors, DS18B20_SENSOR, value, configure, status);